  ...
  if (error) {
    ...
    $.ajax(`${verificationDomain}/api/uw_flow/stripe/newPaymentMethod`, {
      ...
      .done((data) => {
        ...
        $("div.step-3").html(
          '<svg class="checkmark mx-auto mb-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52"><circle class="checkmark__circle" cx="26" cy="26" r="25" fill="none"/><path class="checkmark__check" fill="none" d="M14.1 27.2l7.1 7.2 16.7-16.8"/></svg><h1 class="my-sm-4 heading-title col-md-11 mx-auto mb-5">Account verified!</h1><span>Your Account is successfully verified and linked!</span>'
        );

        setTimeout(function () {
          $("div.step-3").html(
            '<h1 class="my-4 completed-process-title ">Thank you!</h1><h4 class="completed-process-description">You have completed your customer verification process, we will review your application and get back to you.</h4></br><a class="w-100 justify-content-center" href="/"><button class="btn btn-access mb-3 my-4">Continue to Dashboard</button></a>'
          );
        }, 2000);
      })
      .fail((data) => {
